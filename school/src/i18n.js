...
const messages = {
  en: {
    ...
    notLoggedIn: 'You must be logged in to add items to your cart.',
  },
  nl: {
    ...
    addedToCart: 'Item toegevoegd aan winkelwagen!',
    checkout: 'Afrekenen',
    ...
    priceMustBeNumber: 'Prijs moet een getal zijn.',
    failedToUpdateEvent: 'Bijwerken van evenement mislukt.',
    failedToAddEvent: 'Toevoegen van evenement mislukt.',
    fillAllFields: 'Vul alle velden in.',
    eventCrud: 'Evenementenbeheer',
    actions: 'Acties',
    save: 'Opslaan',
    delete: 'Verwijderen',
    add: 'Toevoegen',
    ...
    eventAdded: 'Evenement toegevoegd!',
    eventUpdated: 'Evenement bijgewerkt!',
    eventDeleted: 'Evenement verwijderd!',
    failedToDeleteEvent: 'Verwijderen van evenement mislukt.',
    notLoggedIn: 'Je moet ingelogd zijn om items aan je winkelwagen toe te voegen.',
  },
